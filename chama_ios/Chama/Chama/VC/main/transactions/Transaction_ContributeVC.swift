//
//  Transaction_ContributeVC.swift
//  Chama
//
...
class Transaction_ContributeVC: SideMenuMainBaseVC {
...
extension Transaction_ContributeVC {
...
extension Transaction_ContributeVC: UITableViewDelegate, UITableViewDataSource {
